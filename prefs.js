...
function addTagToFilter(frame) {
    ...
    let inputFilterTag = new Gtk.Entry({width_chars : 35, text: settingsJSON['aws_filter_tag_value']});
...
function addAwsCliProfile(frame) {
    ...
    let inputAwsCliProfile = new Gtk.Entry({width_chars : 35, text: settingsJSON['aws_cli_profile']});
...
function addSshUserName(frame) {
    ...
    let inputUserName = new Gtk.Entry({width_chars : 35, text: settingsJSON['username']});
...
function addSshPublicKey(frame) {
    ...
    let inputSshPublicKey = new Gtk.Entry({width_chars : 35, text: settingsJSON['ssh_key']});
