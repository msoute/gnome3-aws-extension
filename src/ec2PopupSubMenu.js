...
const Ec2PopupSubMenu = new Lang.Class({
    ...
    _init: function (publicIp, privateIp, environment, instanceId, settings, params) {
        ...
        this.menu.addMenuItem(new Ec2PopupSubMenuConnectItem.Ec2PopupSubMenuConnectItem(this.settingsJson, this.publicIp, this.privateIp, this.instanceId, environment,{}));
